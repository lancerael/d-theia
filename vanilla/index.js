...
function r(t3) {
  var n2 = (t3 += ''),
    e2 = n2.indexOf(':')
  if (e2 >= 0 && 'xmlns' !== (n2 = t3.slice(0, e2))) t3 = t3.slice(e2 + 1)
  return i.hasOwnProperty(n2) ? { space: i[n2], local: t3 } : t3
}
function a(t3) {
  return function () {
    var n2 = this.ownerDocument,
      i2 = this.namespaceURI
    return i2 === e && n2.documentElement.namespaceURI === e
      ? n2.createElement(t3)
      : n2.createElementNS(i2, t3)
  }
}
function o(t3) {
  return function () {
...
function h(t3) {
  if ('function' !== typeof t3) t3 = l(t3)
  for (
    var n2 = this._groups, e2 = n2.length, i2 = new Array(e2), r2 = 0;
    r2 < e2;
    ++r2
  )
    for (
      ...
      if ((u2 = a2[c2]) && (h2 = t3.call(u2, u2.__data__, c2, a2))) {
        if ('__data__' in u2) h2.__data__ = u2.__data__
        s2[c2] = h2
      }
...
function d(t3) {
  if ('function' !== typeof t3) t3 = f(t3)
  for (
    var n2 = this._groups, e2 = n2.length, i2 = [], r2 = [], a2 = 0;
    a2 < e2;
    ++a2
  )
...
function g(t3) {
  ...
  for (
    ...
    for (
      var a2 = n2[r2], o2 = a2.length, s2 = (i2[r2] = []), u2, l2 = 0;
      l2 < o2;
      ++l2
    )
      if ((u2 = a2[l2]) && t3.call(u2, u2.__data__, l2, a2)) s2.push(u2)
  return new Bt(i2, this._parents)
}
function v(t3) {
...
function x(t3, n2, e2, i2, r2, a2) {
  ...
  for (; o2 < l2; ++o2)
    if ((s2 = n2[o2])) {
      s2.__data__ = a2[o2]
      i2[o2] = s2
    } else e2[o2] = new y(t3, a2[o2])
  for (; o2 < u2; ++o2) if ((s2 = n2[o2])) r2[o2] = s2
}
function b(t3, n2, e2, i2, r2, a2, o2) {
  ...
  for (s2 = 0; s2 < c2; ++s2) {
    ...
    if ((u2 = l2[d2])) {
      ...
      u2.__data__ = a2[s2]
      l2[d2] = null
    } else e2[s2] = new y(t3, a2[s2])
  }
  for (s2 = 0; s2 < h2; ++s2)
    if ((u2 = n2[s2]) && l2[f2[s2]] === u2) r2[s2] = u2
}
function C(t3, n2) {
  if (!t3) {
  ...
  for (
    ...
    var h2 = i2[l2],
      c2 = r2[l2],
      f2 = c2.length,
      d2 = t3.call(h2, h2 && h2.__data__, l2, i2),
      p2 = d2.length,
      g2 = (s2[l2] = new Array(p2)),
      v2 = (o2[l2] = new Array(p2)),
      m2 = (u2[l2] = new Array(f2))
  ...
  for (
    ...
    for (
      var u2 = n2[s2],
        l2 = e2[s2],
        h2 = u2.length,
        c2 = (o2[s2] = new Array(h2)),
        f2,
        d2 = 0;
      d2 < h2;
      ++d2
    )
      if ((f2 = u2[d2] || l2[d2])) c2[d2] = f2
  for (; s2 < i2; ++s2) o2[s2] = n2[s2]
...
function T(t3) {
  ...
  for (
    var e2 = this._groups, i2 = e2.length, r2 = new Array(i2), a2 = 0;
    a2 < i2;
    ++a2
  ) {
    for (
      var o2 = e2[a2],
        s2 = o2.length,
        u2 = (r2[a2] = new Array(s2)),
        l2,
        h2 = 0;
      h2 < s2;
      ++h2
    )
      if ((l2 = o2[h2])) u2[h2] = l2
    u2.sort(n2)
  }
...
function P(t3) {
  for (var n2 = this._groups, e2 = 0, i2 = n2.length; e2 < i2; ++e2)
    for (var r2 = n2[e2], a2 = 0, o2 = r2.length, s2; a2 < o2; ++a2)
      if ((s2 = r2[a2])) t3.call(s2, s2.__data__, a2, r2)
  return this
}
function I(t3) {
  return function () {
...
function H(t3, n2) {
  return function () {
    ...
    if (null == e2) this.removeAttribute(t3)
    else this.setAttribute(t3, e2)
  }
}
function X(t3, n2) {
  return function () {
    var e2 = n2.apply(this, arguments)
    if (null == e2) this.removeAttributeNS(t3.space, t3.local)
    else this.setAttributeNS(t3.space, t3.local, e2)
  }
}
function z(t3, n2) {
  var e2 = r(t3)
  if (arguments.length < 2) {
    var i2 = this.node()
    return e2.local
      ? i2.getAttributeNS(e2.space, e2.local)
      : i2.getAttribute(e2)
  }
  return this.each(
    (null == n2
...
function B(t3) {
  return (
    (t3.ownerDocument && t3.ownerDocument.defaultView) ||
    (t3.document && t3) ||
    t3.defaultView
  )
}
...
function Y(t3, n2, e2) {
  return function () {
    ...
    if (null == i2) this.style.removeProperty(t3)
    else this.style.setProperty(t3, i2, e2)
  }
}
function G(t3, n2, e2) {
  return arguments.length > 1
    ? this.each(
        (null == n2 ? q : 'function' === typeof n2 ? Y : W)(
          t3,
          n2,
          null == e2 ? '' : e2
        )
...
function F(t3, n2) {
  return (
    t3.style.getPropertyValue(n2) ||
    B(t3).getComputedStyle(t3, null).getPropertyValue(n2)
  )
}
function K(t3) {
  return function () {
...
function J(t3, n2) {
  return function () {
    var e2 = n2.apply(this, arguments)
    if (null == e2) delete this[t3]
    else this[t3] = e2
  }
}
function Z(t3, n2) {
  return arguments.length > 1
    ? this.each((null == n2 ? K : 'function' === typeof n2 ? J : U)(t3, n2))
    : this.node()[t3]
}
function Q(t3) {
...
function et(t3, n2) {
  var e2 = tt(t3),
    i2 = -1,
    r2 = n2.length
  while (++i2 < r2) e2.add(n2[i2])
}
function it(t3, n2) {
  var e2 = tt(t3),
    i2 = -1,
    r2 = n2.length
  while (++i2 < r2) e2.remove(n2[i2])
}
function rt(t3) {
  return function () {
    et(this, t3)
...
function st(t3, n2) {
  ...
  if (arguments.length < 2) {
    var i2 = tt(this.node()),
      r2 = -1,
      a2 = e2.length
    while (++r2 < a2) if (!i2.contains(e2[r2])) return false
    return true
  }
...
function ct(t3) {
  return arguments.length
    ? this.each(null == t3 ? ut : ('function' === typeof t3 ? ht : lt)(t3))
...
function gt(t3) {
  return arguments.length
    ? this.each(null == t3 ? ft : ('function' === typeof t3 ? pt : dt)(t3))
    : this.node().innerHTML
}
function vt() {
...
function bt(t3, n2) {
  var e2 = 'function' === typeof t3 ? t3 : s(t3),
    i2 = null == n2 ? xt : 'function' === typeof n2 ? n2 : l(n2)
  return this.select(function () {
    return this.insertBefore(
      e2.apply(this, arguments),
      i2.apply(this, arguments) || null
    )
  })
}
function Ct() {
  var t3 = this.parentNode
  if (t3) t3.removeChild(this)
}
function Mt() {
  return this.each(Ct)
}
function Nt() {
  var t3 = this.cloneNode(false),
    n2 = this.parentNode
  return n2 ? n2.insertBefore(t3, this.nextSibling) : t3
}
function At() {
  var t3 = this.cloneNode(true),
    n2 = this.parentNode
  return n2 ? n2.insertBefore(t3, this.nextSibling) : t3
}
function kt(t3) {
...
function Dt(t3) {
  return t3
    ...
    .map(function (t4) {
      var n2 = '',
        e2 = t4.indexOf('.')
      if (e2 >= 0) (n2 = t4.slice(e2 + 1)), (t4 = t4.slice(0, e2))
...
function Pt(t3) {
  return function () {
    ...
    for (var e2 = 0, i2 = -1, r2 = n2.length, a2; e2 < r2; ++e2)
      if (
        ((a2 = n2[e2]),
        (!t3.type || a2.type === t3.type) && a2.name === t3.name)
      )
...
function $t(t3, n2, e2) {
  ...
  s2 = n2 ? It : Pt
  if (null == e2) e2 = false
  for (r2 = 0; r2 < a2; ++r2) this.each(s2(i2[r2], n2, e2))
  return this
}
function Ot(t3, n2, e2) {
  var i2 = B(t3),
    r2 = i2.CustomEvent
  if ('function' === typeof r2) r2 = new r2(n2, e2)
  else {
    r2 = i2.document.createEvent('Event')
    if (e2) r2.initEvent(n2, e2.bubbles, e2.cancelable), (r2.detail = e2.detail)
    else r2.initEvent(n2, false, false)
  }
  t3.dispatchEvent(r2)
}
function Rt(t3, n2) {
...
function Wt(t3) {
  return 'string' === typeof t3
    ? new Bt([[document.querySelector(t3)]], [document.documentElement])
    : new Bt([[t3]], zt)
}
...
function Kt(t3, n2) {
  return t3
    ...
    .map(function (t4) {
      var e2 = '',
        i2 = t4.indexOf('.')
      if (i2 >= 0) (e2 = t4.slice(i2 + 1)), (t4 = t4.slice(0, i2))
      if (t4 && !n2.hasOwnProperty(t4)) throw new Error('unknown type: ' + t4)
      return { type: t4, name: e2 }
    })
}
Ft.prototype = Gt.prototype = {
  constructor: Ft,
  on: function (t3, n2) {
    var e2 = this._,
      i2 = Kt(t3 + '', e2),
    ...
    if (arguments.length < 2) {
      while (++a2 < o2)
        if ((r2 = (t3 = i2[a2]).type) && (r2 = Ut(e2[r2], t3.name))) return r2
      return
    }
    if (null != n2 && 'function' !== typeof n2)
      throw new Error('invalid callback: ' + n2)
    while (++a2 < o2)
      if ((r2 = (t3 = i2[a2]).type)) e2[r2] = Jt(e2[r2], t3.name, n2)
      else if (null == n2) for (r2 in e2) e2[r2] = Jt(e2[r2], t3.name, null)
    return this
  },
  copy: function () {
    var t3 = {},
      n2 = this._
    for (var e2 in n2) t3[e2] = n2[e2].slice()
    return new Ft(t3)
  },
  call: function (t3, n2) {
...
function Ut(t3, n2) {
  for (var e2 = 0, i2 = t3.length, r2; e2 < i2; ++e2)
    if ((r2 = t3[e2]).name === n2) return r2.value
}
function Jt(t3, n2, e2) {
  ...
  if (null != e2) t3.push({ name: n2, value: e2 })
  return t3
}
var Zt = 0,
  Qt = 0,
  ...
  on = 0,
  sn = 0,
  un = 'object' === typeof performance && performance.now ? performance : Date,
  ln =
...
fn.prototype = dn.prototype = {
  constructor: fn,
  restart: function (t3, n2, e2) {
...
function pn() {
  ...
  var t3 = en,
    n2
  while (t3) {
    if ((n2 = on - t3._time) >= 0) t3._call.call(null, n2)
    t3 = t3._next
  }
  --Zt
}
...
function yn(t3) {
  if (Zt) return
  if (Qt) Qt = clearTimeout(Qt)
  var n2 = t3 - on
  if (n2 > 24) {
    if (t3 < 1 / 0) Qt = setTimeout(gn, t3 - un.now() - sn)
    if (tn) tn = clearInterval(tn)
  } else {
    if (!tn) (an = un.now()), (tn = setInterval(vn, nn))
    ;(Zt = 1), ln(gn)
  }
}
...
function En(t3, n2) {
  var e2 = Ln(t3, n2)
  if (e2.state > bn) throw new Error('too late; already scheduled')
  return e2
}
function jn(t3, n2) {
  var e2 = Ln(t3, n2)
  if (e2.state > Nn) throw new Error('too late; already running')
  return e2
}
function Ln(t3, n2) {
  var e2 = t3.__transition
  if (!e2 || !(e2 = e2[n2])) throw new Error('transition not found')
  return e2
}
function Vn(t3, n2, e2) {
  var i2 = t3.__transition,
    r2
  i2[n2] = e2
  ...
  function a2(t4) {
    ...
    if (e2.delay <= t4) o2(t4 - e2.delay)
  }
  function o2(a3) {
    var l2, h2, c2, f2
    if (e2.state !== Cn) return u2()
    for (l2 in i2) {
      f2 = i2[l2]
      if (f2.name !== e2.name) continue
      if (f2.state === Nn) return _n(o2)
      if (f2.state === An) {
        f2.state = Tn
        f2.timer.stop()
  ...
  function s2(n3) {
    var i3 =
        n3 < e2.duration
          ? e2.ease.call(null, n3 / e2.duration)
          : (e2.timer.restart(u2), (e2.state = kn), 1),
      a3 = -1,
      o3 = r2.length
    while (++a3 < o3) r2[a3].call(t3, i3)
    if (e2.state === kn) {
...
var Xn = '\\s*([+-]?\\d+)\\s*',
  ...
  Yn = new RegExp('^rgb\\(' + [Bn, Bn, Bn] + '\\)$'),
  Gn = new RegExp('^rgba\\(' + [Xn, Xn, Xn, zn] + '\\)$'),
  Fn = new RegExp('^rgba\\(' + [Bn, Bn, Bn, zn] + '\\)$'),
  Kn = new RegExp('^hsl\\(' + [zn, Bn, Bn] + '\\)$'),
  Un = new RegExp('^hsla\\(' + [zn, Bn, Bn, zn] + '\\)$')
var Jn = {
  aliceblue: 15792383,
  ...
  return (n2 = qn.exec(t3))
    ? ((e2 = n2[1].length),
      ...
      6 === e2
        ...
        : null)
    : (n2 = Wn.exec(t3))
    ? new oe(n2[1], n2[2], n2[3], 1)
    : (n2 = Yn.exec(t3))
    ? new oe((255 * n2[1]) / 100, (255 * n2[2]) / 100, (255 * n2[3]) / 100, 1)
    : (n2 = Gn.exec(t3))
    ? ie(n2[1], n2[2], n2[3], n2[4])
    : (n2 = Fn.exec(t3))
    ? ie((255 * n2[1]) / 100, (255 * n2[2]) / 100, (255 * n2[3]) / 100, n2[4])
    : (n2 = Kn.exec(t3))
    ? he(n2[1], n2[2] / 100, n2[3] / 100, 1)
    : (n2 = Un.exec(t3))
    ? he(n2[1], n2[2] / 100, n2[3] / 100, n2[4])
    : Jn.hasOwnProperty(t3)
    ? ee(Jn[t3])
    : 'transparent' === t3
...
function ie(t3, n2, e2, i2) {
  if (i2 <= 0) t3 = n2 = e2 = NaN
  return new oe(t3, n2, e2, i2)
}
function re(t3) {
  if (!(t3 instanceof On)) t3 = ne(t3)
  if (!t3) return new oe()
  t3 = t3.rgb()
...
function he(t3, n2, e2, i2) {
  if (i2 <= 0) t3 = n2 = e2 = NaN
  else if (e2 <= 0 || e2 >= 1) t3 = n2 = NaN
  else if (n2 <= 0) t3 = NaN
  return new de(t3, n2, e2, i2)
}
function ce(t3) {
  if (t3 instanceof de) return new de(t3.h, t3.s, t3.l, t3.opacity)
  if (!(t3 instanceof On)) t3 = ne(t3)
  if (!t3) return new de()
  if (t3 instanceof de) return t3
  t3 = t3.rgb()
  var n2 = t3.r / 255,
    e2 = t3.g / 255,
    i2 = t3.b / 255,
    r2 = Math.min(n2, e2, i2),
    a2 = Math.max(n2, e2, i2),
    o2 = NaN,
    s2 = a2 - r2,
    u2 = (a2 + r2) / 2
  if (s2) {
    if (n2 === a2) o2 = (e2 - i2) / s2 + 6 * (e2 < i2)
    else if (e2 === a2) o2 = (i2 - n2) / s2 + 2
    else o2 = (n2 - e2) / s2 + 4
    s2 /= u2 < 0.5 ? a2 + r2 : 2 - a2 - r2
    o2 *= 60
  } else s2 = u2 > 0 && u2 < 1 ? 0 : o2
  return new de(o2, s2, u2, t3.opacity)
}
function fe(t3, n2, e2, i2) {
  return 1 === arguments.length
    ? ce(t3)
    : new de(t3, n2, e2, null == i2 ? 1 : i2)
}
...
In(
  ...
  $n(On, {
    ...
    rgb: function () {
      var t3 = (this.h % 360) + 360 * (this.h < 0),
        n2 = isNaN(t3) || isNaN(this.s) ? 0 : this.s,
        e2 = this.l,
        i2 = e2 + (e2 < 0.5 ? e2 : 1 - e2) * n2,
        r2 = 2 * e2 - i2
      return new oe(
        pe(t3 >= 240 ? t3 - 240 : t3 + 120, r2, i2),
        pe(t3, r2, i2),
        pe(t3 < 120 ? t3 + 240 : t3 - 120, r2, i2),
        this.opacity
      )
    },
    displayable: function () {
...
const we = (function t2(n2) {
  var e2 = ye(n2)
  function i2(t3, n3) {
    var i3 = e2((t3 = ae(t3)).r, (n3 = ae(n3)).r),
      r2 = e2(t3.g, n3.g),
      a2 = e2(t3.b, n3.b),
      o2 = _e(t3.opacity, n3.opacity)
    return function (n4) {
      t3.r = i3(n4)
      t3.g = r2(n4)
      t3.b = a2(n4)
...
function xe(t3, n2) {
  if (!n2) n2 = []
  var e2 = t3 ? Math.min(n2.length, t3.length) : 0,
    i2 = n2.slice(),
    r2
  return function (a2) {
    for (r2 = 0; r2 < e2; ++r2) i2[r2] = t3[r2] * (1 - a2) + n2[r2] * a2
    return i2
  }
}
function be(t3) {
...
function Ce(t3, n2) {
  var e2 = n2 ? n2.length : 0,
    i2 = t3 ? Math.min(e2, t3.length) : 0,
    r2 = new Array(i2),
    a2 = new Array(e2),
    o2
  for (o2 = 0; o2 < i2; ++o2) r2[o2] = Le(t3[o2], n2[o2])
  for (; o2 < e2; ++o2) a2[o2] = n2[o2]
  return function (t4) {
    for (o2 = 0; o2 < i2; ++o2) a2[o2] = r2[o2](t4)
    return a2
  }
}
function Me(t3, n2) {
...
function Ae(t3, n2) {
  var e2 = {},
    i2 = {},
    r2
  if (null === t3 || 'object' !== typeof t3) t3 = {}
  if (null === n2 || 'object' !== typeof n2) n2 = {}
  for (r2 in n2)
    if (r2 in t3) e2[r2] = Le(t3[r2], n2[r2])
    else i2[r2] = n2[r2]
  return function (t4) {
    for (r2 in e2) i2[r2] = e2[r2](t4)
    return i2
  }
}
var ke = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
  Te = new RegExp(ke.source, 'g')
function Se(t3) {
  return function () {
    return t3
  }
...
function je(t3, n2) {
  var e2 = (ke.lastIndex = Te.lastIndex = 0),
    i2,
    r2,
    a2,
    o2 = -1,
  ...
  return s2.length < 2
    ...
    : ((n2 = u2.length),
      function (t4) {
        for (var e3 = 0, i3; e3 < n2; ++e3) s2[(i3 = u2[e3]).i] = i3.x(t4)
        return s2.join('')
      })
}
function Le(t3, n2) {
  ...
  return null == n2 || 'boolean' === e2
    ...
    : ('number' === e2
        ...
        : Array.isArray(n2)
        ? Ce
        : ('function' !== typeof n2.valueOf &&
            'function' !== typeof n2.toString) ||
          isNaN(n2)
        ? Ae
        : Ne)(t3, n2)
}
...
function Ie(t3, n2, e2, i2, r2, a2) {
  var o2, s2, u2
  if ((o2 = Math.sqrt(t3 * t3 + n2 * n2))) (t3 /= o2), (n2 /= o2)
  if ((u2 = t3 * e2 + n2 * i2)) (e2 -= t3 * u2), (i2 -= n2 * u2)
  if ((s2 = Math.sqrt(e2 * e2 + i2 * i2))) (e2 /= s2), (i2 /= s2), (u2 /= s2)
  if (t3 * i2 < n2 * e2) (t3 = -t3), (n2 = -n2), (u2 = -u2), (o2 = -o2)
  return {
    translateX: r2,
    translateY: a2,
    rotate: Math.atan2(n2, t3) * De,
    skewX: Math.atan(u2) * De,
    scaleX: o2,
    scaleY: s2,
  }
}
var $e, Oe, Re, He
function Xe(t3) {
  if ('none' === t3) return Pe
  if (!$e)
    ($e = document.createElement('DIV')),
      (Oe = document.documentElement),
      (Re = document.defaultView)
  $e.style.transform = t3
  t3 = Re.getComputedStyle(Oe.appendChild($e), null).getPropertyValue(
    'transform'
  )
  Oe.removeChild($e)
...
function ze(t3) {
  if (null == t3) return Pe
  if (!He) He = document.createElementNS('http://www.w3.org/2000/svg', 'g')
  He.setAttribute('transform', t3)
  if (!(t3 = He.transform.baseVal.consolidate())) return Pe
  t3 = t3.matrix
  ...
  return function (n3, e3) {
    ...
    return function (t4) {
      var n4 = -1,
        e4 = r3.length,
        a3
      while (++n4 < e4) i3[(a3 = r3[n4]).i] = a3.x(t4)
      return i3.join('')
    }
  }
}
...
function Ge(t3, n2, e2) {
  ...
  return function () {
    ...
    if (o2 !== i2) {
      r2 = (i2 = o2).slice()
      for (
        var s2 = { name: n2, value: e2 }, u2 = 0, l2 = r2.length;
        u2 < l2;
        ++u2
      )
        if (r2[u2].name === n2) {
...
function Fe(t3, n2) {
  ...
  if (arguments.length < 2) {
    ...
    for (var r2 = 0, a2 = i2.length, o2; r2 < a2; ++r2)
      if ((o2 = i2[r2]).name === t3) return o2.value
    return null
  }
...
function ni(t3, n2, e2) {
  ...
  return function () {
    var o2,
      s2 = e2(this),
      u2
    if (null == s2) return void this.removeAttribute(t3)
...
function ei(t3, n2, e2) {
  ...
  return function () {
    var o2,
      s2 = e2(this),
      u2
    if (null == s2) return void this.removeAttributeNS(t3.space, t3.local)
...
function ii(t3, n2) {
  var e2 = r(t3),
    i2 = 'transform' === e2 ? We : Ue
  return this.attrTween(
    t3,
    'function' === typeof n2
      ? (e2.local ? ei : ni)(e2, i2, Ke(this, 'attr.' + t3, n2))
      : null == n2
      ? (e2.local ? Ze : Je)(e2)
      : (e2.local ? ti : Qe)(e2, i2, n2)
  )
}
function ri(t3, n2) {
  return function (e2) {
...
function ui(t3, n2) {
  var e2 = 'attr.' + t3
  if (arguments.length < 2) return (e2 = this.tween(e2)) && e2._value
  if (null == n2) return this.tween(e2, null)
...
function ci(t3) {
  var n2 = this._id
  return arguments.length
    ? this.each(('function' === typeof t3 ? li : hi)(n2, t3))
    : Ln(this.node(), n2).delay
}
function fi(t3, n2) {
  return function () {
...
function pi(t3) {
  var n2 = this._id
  return arguments.length
    ? this.each(('function' === typeof t3 ? fi : di)(n2, t3))
    : Ln(this.node(), n2).duration
}
function gi(t3, n2) {
  if ('function' !== typeof n2) throw new Error()
  return function () {
...
function wi(t3, n2, e2) {
  ...
  return function () {
    var o2 = a2(this, t3),
      s2 = o2.on
    if (s2 !== i2) (r2 = (i2 = s2).copy()).on(n2, e2)
    o2.on = r2
  }
}
function xi(t3, n2) {
  ...
  return arguments.length < 2
    ? Ln(this.node(), e2).on.on(t3)
    : this.each(wi(e2, t3, n2))
}
function bi(t3) {
  return function () {
    var n2 = this.parentNode
    for (var e2 in this.__transition) if (+e2 !== t3) return
    if (n2) n2.removeChild(this)
  }
}
function Ci() {
...
function Mi(t3) {
  ...
  if ('function' !== typeof t3) t3 = l(t3)
  for (
    var i2 = this._groups, r2 = i2.length, a2 = new Array(r2), o2 = 0;
    o2 < r2;
    ++o2
  )
    for (
      ...
      if ((c2 = s2[d2]) && (f2 = t3.call(c2, c2.__data__, d2, s2))) {
        if ('__data__' in c2) f2.__data__ = c2.__data__
        h2[d2] = f2
...
function Ni(t3) {
  ...
  if ('function' !== typeof t3) t3 = f(t3)
  for (
    var i2 = this._groups, r2 = i2.length, a2 = [], o2 = [], s2 = 0;
    s2 < r2;
    ++s2
  )
    for (var u2 = i2[s2], l2 = u2.length, h2, c2 = 0; c2 < l2; ++c2)
      if ((h2 = u2[c2])) {
        for (
          var d2 = t3.call(h2, h2.__data__, c2, u2),
            p2,
            g2 = Ln(h2, e2),
            v2 = 0,
            m2 = d2.length;
          ...
          if ((p2 = d2[v2])) Sn(p2, n2, e2, v2, d2, g2)
        a2.push(d2)
        o2.push(h2)
      }
...
function Ti(t3, n2) {
  ...
  return function () {
    var a2 = F(this, t3),
      o2 = (this.style.removeProperty(t3), F(this, t3))
    return a2 === o2
      ? null
      : a2 === e2 && o2 === i2
      ? r2
...
function ji(t3, n2, e2) {
  ...
  return function () {
    var o2 = F(this, t3),
      s2 = e2(this),
      u2 = s2 + ''
    if (null == s2) u2 = s2 = (this.style.removeProperty(t3), F(this, t3))
    return o2 === u2
      ? null
      : o2 === i2 && u2 === r2
      ? a2
...
function Li(t3, n2) {
  ...
  return function () {
    var u2 = jn(this, t3),
      l2 = u2.on,
      h2 = null == u2.value[a2] ? s2 || (s2 = Si(n2)) : void 0
    if (l2 !== e2 || r2 !== h2) (i2 = (e2 = l2).copy()).on(o2, (r2 = h2))
    u2.on = i2
  }
}
function Vi(t3, n2, e2) {
  ...
  return null == n2
    ? this.styleTween(t3, Ti(t3, i2)).on('end.style.' + t3, Si(t3))
    : 'function' === typeof n2
    ? this.styleTween(t3, ji(t3, i2, Ke(this, 'style.' + t3, n2))).each(
        Li(this._id, t3)
      )
    : this.styleTween(t3, Ei(t3, i2, n2), e2).on('end.style.' + t3, null)
}
...
function Ii(t3, n2, e2) {
  var i2 = 'style.' + (t3 += '')
  if (arguments.length < 2) return (i2 = this.tween(i2)) && i2._value
  if (null == n2) return this.tween(i2, null)
  if ('function' !== typeof n2) throw new Error()
...
function zi(t3) {
  var n2 = 'text'
  if (arguments.length < 1) return (n2 = this.tween(n2)) && n2._value
  if (null == t3) return this.tween(n2, null)
  if ('function' !== typeof t3) throw new Error()
  ...
  for (var i2 = this._groups, r2 = i2.length, a2 = 0; a2 < r2; ++a2)
    for (var o2 = i2[a2], s2 = o2.length, u2, l2 = 0; l2 < s2; ++l2)
      if ((u2 = o2[l2])) {
        var h2 = Ln(u2, n2)
        Sn(u2, t3, e2, l2, o2, {
          time: h2.time + h2.delay + h2.duration,
          delay: 0,
...
function Ui(t3, n2) {
  ...
  while (!(e2 = t3.__transition) || !(e2 = e2[n2]))
    if (!(t3 = t3.parentNode)) return (Ki.time = hn()), Ki
  return e2
}
function Ji(t3) {
  var n2, e2
  if (t3 instanceof Yi) (n2 = t3._id), (t3 = t3._name)
  else (n2 = Gi()), ((e2 = Ki).time = hn()), (t3 = null == t3 ? null : t3 + '')
  for (var i2 = this._groups, r2 = i2.length, a2 = 0; a2 < r2; ++a2)
    for (var o2 = i2[a2], s2 = o2.length, u2, l2 = 0; l2 < s2; ++l2)
      if ((u2 = o2[l2])) Sn(u2, t3, n2, l2, o2, e2 || Ui(u2, n2))
...
function Qi(t3) {
  if (1 === t3.length) t3 = tr(t3)
  return {
    left: function (n2, e2, i2, r2) {
      if (null == i2) i2 = 0
      if (null == r2) r2 = n2.length
      while (i2 < r2) {
        var a2 = (i2 + r2) >>> 1
        if (t3(n2[a2], e2) < 0) i2 = a2 + 1
        else r2 = a2
      }
      return i2
    },
...
function ir(t3, n2, e2) {
  ;(t3 = +t3),
    (n2 = +n2),
    (e2 =
      (r2 = arguments.length) < 2 ? ((n2 = t3), (t3 = 0), 1) : r2 < 3 ? 1 : +e2)
  var i2 = -1,
    r2 = 0 | Math.max(0, Math.ceil((n2 - t3) / e2)),
    a2 = new Array(r2)
  while (++i2 < r2) a2[i2] = t3 + i2 * e2
  return a2
}
var rr = Math.sqrt(50),
  ar = Math.sqrt(10),
...
function sr(t3, n2, e2) {
  var i2,
    ...
    s2
  ;(n2 = +n2), (t3 = +t3), (e2 = +e2)
  if (t3 === n2 && e2 > 0) return [t3]
  if ((i2 = n2 < t3)) (a2 = t3), (t3 = n2), (n2 = a2)
  if (0 === (s2 = ur(t3, n2, e2)) || !isFinite(s2)) return []
  if (s2 > 0) {
    t3 = Math.ceil(t3 / s2)
    n2 = Math.floor(n2 / s2)
    o2 = new Array((a2 = Math.ceil(n2 - t3 + 1)))
    while (++r2 < a2) o2[r2] = (t3 + r2) * s2
  } else {
    t3 = Math.floor(t3 * s2)
    n2 = Math.ceil(n2 * s2)
...
function ur(t3, n2, e2) {
  var i2 = (n2 - t3) / Math.max(0, e2),
    r2 = Math.floor(Math.log(i2) / Math.LN10),
    a2 = i2 / Math.pow(10, r2)
  return r2 >= 0
    ? (a2 >= rr ? 10 : a2 >= ar ? 5 : a2 >= or ? 2 : 1) * Math.pow(10, r2)
    : -Math.pow(10, -r2) / (a2 >= rr ? 10 : a2 >= ar ? 5 : a2 >= or ? 2 : 1)
}
function lr(t3, n2, e2) {
  var i2 = Math.abs(n2 - t3) / Math.max(0, e2),
    r2 = Math.pow(10, Math.floor(Math.log(i2) / Math.LN10)),
    a2 = i2 / r2
  if (a2 >= rr) r2 *= 10
  else if (a2 >= ar) r2 *= 5
  else if (a2 >= or) r2 *= 2
  ...
  if (null == n2) {
    while (++i2 < e2)
      if (null != (r2 = t3[i2]) && r2 >= r2) {
        a2 = r2
        while (++i2 < e2) if (null != (r2 = t3[i2]) && r2 > a2) a2 = r2
      }
  } else
    while (++i2 < e2)
      if (null != (r2 = n2(t3[i2], i2, t3)) && r2 >= r2) {
        a2 = r2
        while (++i2 < e2)
          if (null != (r2 = n2(t3[i2], i2, t3)) && r2 > a2) a2 = r2
      }
  return a2
}
function cr(t3, n2) {
  ...
  if (null == n2) {
    while (++i2 < e2)
      if (null != (r2 = t3[i2]) && r2 >= r2) {
        a2 = r2
        while (++i2 < e2) if (null != (r2 = t3[i2]) && a2 > r2) a2 = r2
      }
  } else
    while (++i2 < e2)
      if (null != (r2 = n2(t3[i2], i2, t3)) && r2 >= r2) {
        a2 = r2
        while (++i2 < e2)
          if (null != (r2 = n2(t3[i2], i2, t3)) && a2 > r2) a2 = r2
      }
  return a2
}
function fr(t3, n2) {
...
pr.prototype = gr.prototype = {
  ...
  clear: function () {
    for (var t3 in this) if (t3[0] === dr) delete this[t3]
  },
  keys: function () {
    var t3 = []
    for (var n2 in this) if (n2[0] === dr) t3.push(n2.slice(1))
    return t3
  },
  values: function () {
    var t3 = []
    for (var n2 in this) if (n2[0] === dr) t3.push(this[n2])
    return t3
  },
  entries: function () {
    var t3 = []
    for (var n2 in this)
      if (n2[0] === dr) t3.push({ key: n2.slice(1), value: this[n2] })
    return t3
  },
  size: function () {
    var t3 = 0
    for (var n2 in this) if (n2[0] === dr) ++t3
    return t3
  },
  empty: function () {
    for (var t3 in this) if (t3[0] === dr) return false
    return true
  },
  each: function (t3) {
    for (var n2 in this) if (n2[0] === dr) t3(this[n2], n2.slice(1), this)
  },
}
function gr(t3, n2) {
  var e2 = new pr()
  if (t3 instanceof pr)
    ...
    var i2 = -1,
      r2 = t3.length,
      a2
    if (null == n2) while (++i2 < r2) e2.set(i2, t3[i2])
    else while (++i2 < r2) e2.set(n2((a2 = t3[i2]), i2, t3), a2)
  } else if (t3) for (var o2 in t3) e2.set(o2, t3[o2])
  return e2
}
function vr() {}
var mr = gr.prototype
...
function br() {
  ...
  r2.domain = function (e3) {
    ...
    var i3 = -1,
      ...
      s2
    while (++i3 < a2)
      if (!t3.has((s2 = (o2 = e3[i3]) + ''))) t3.set(s2, n2.push(o2))
    return r2
  }
...
function Cr() {
  ...
  function h2() {
    ...
    if (o2) r2 = Math.floor(r2)
    c2 += (f2 - c2 - r2 * (t4 - s2)) * l2
    a2 = r2 * (1 - s2)
    if (o2) (c2 = Math.round(c2)), (a2 = Math.round(a2))
...
function Lr(t3, n2, e2) {
  var i2 = t3[0],
    ...
    a2 = n2[0],
    o2 = n2[1]
  if (r2 < i2) (i2 = Er(r2, i2)), (a2 = e2(o2, a2))
  else (i2 = Er(i2, r2)), (a2 = e2(a2, o2))
  return function (t4) {
    return a2(i2(t4))
  }
}
function Vr(t3, n2, e2) {
  var i2 = Math.min(t3.length, n2.length) - 1,
    r2 = new Array(i2),
    a2 = new Array(i2),
    o2 = -1
  if (t3[i2] < t3[0]) {
...
function Pr() {
  ...
  function c2(r3) {
    return isNaN((r3 = +r3))
      ? a2
      : (u2 || (u2 = s2(t3.map(i2), n2, e2)))(i2(o2(r3)))
  }
  ...
  c2.domain = function (n3) {
    return arguments.length
      ? ((t3 = _r.call(n3, kr)), o2 === Sr || (o2 = jr(t3)), h2())
      : t3.slice()
  }
...
function $r(t3) {
  return Math.abs((t3 = Math.round(t3))) >= 1e21
    ? t3.toLocaleString('en').replace(/,/g, '')
    : t3.toString(10)
}
function Or(t3, n2) {
  if (
    (e2 = (t3 = n2 ? t3.toExponential(n2 - 1) : t3.toExponential()).indexOf(
      'e'
    )) < 0
  )
    return null
...
function Hr(t3, n2) {
  return function (e2, i2) {
    var r2 = e2.length,
      ...
      u2 = 0
    while (r2 > 0 && s2 > 0) {
      if (u2 + s2 + 1 > i2) s2 = Math.max(1, i2 - u2)
...
var zr =
  /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i
function Br(t3) {
  if (!(n2 = zr.exec(t3))) throw new Error('invalid format: ' + t3)
  var n2
  return new qr({
    fill: n2[1],
    align: n2[2],
...
function Wr(t3) {
  t: for (var n2 = t3.length, e2 = 1, i2 = -1, r2; e2 < n2; ++e2)
    switch (t3[e2]) {
      case '.':
        i2 = r2 = e2
        break
...
function Gr(t3, n2) {
  ...
  var i2 = e2[0],
    r2 = e2[1],
    a2 = r2 - (Yr = 3 * Math.max(-8, Math.min(8, Math.floor(r2 / 3)))) + 1,
    o2 = i2.length
  return a2 === o2
    ? i2
    : a2 > o2
    ? i2 + new Array(a2 - o2 + 1).join('0')
    : a2 > 0
    ? i2.slice(0, a2) + '.' + i2.slice(a2)
    : '0.' + new Array(1 - a2).join('0') + Or(t3, Math.max(0, n2 + a2 - 1))[0]
}
function Fr(t3, n2) {
  var e2 = Or(t3, n2)
  if (!e2) return t3 + ''
  var i2 = e2[0],
    r2 = e2[1]
  return r2 < 0
    ? '0.' + new Array(-r2).join('0') + i2
    : i2.length > r2 + 1
    ? i2.slice(0, r2 + 1) + '.' + i2.slice(r2 + 1)
    : i2 + new Array(r2 - i2.length + 2).join('0')
}
const Kr = {
  '%': function (t3, n2) {
...
function Qr(t3) {
  var n2 =
      void 0 === t3.grouping || void 0 === t3.thousands
        ? Ur
        : Hr(Jr.call(t3.grouping, Number), t3.thousands + ''),
    e2 = void 0 === t3.currency ? '' : t3.currency[0] + '',
    i2 = void 0 === t3.currency ? '' : t3.currency[1] + '',
    r2 = void 0 === t3.decimal ? '.' : t3.decimal + '',
    a2 = void 0 === t3.numerals ? Ur : Xr(Jr.call(t3.numerals, String)),
    o2 = void 0 === t3.percent ? '%' : t3.percent + '',
    s2 = void 0 === t3.minus ? '-' : t3.minus + '',
    u2 = void 0 === t3.nan ? 'NaN' : t3.nan + ''
  function l2(t4) {
    t4 = Br(t4)
    var l3 = t4.fill,
      h3 = t4.align,
      ...
      m2 = t4.trim,
      y2 = t4.type
    if ('n' === y2) (g2 = true), (y2 = 'g')
    else if (!Kr[y2]) void 0 === v2 && (v2 = 12), (m2 = true), (y2 = 'g')
    if (d2 || ('0' === l3 && '=' === h3)) (d2 = true), (l3 = '0'), (h3 = '=')
    var _2 =
        '$' === f2
          ? e2
          : '#' === f2 && /[boxX]/.test(y2)
    ...
    v2 =
      void 0 === v2
        ? 6
        : /[gprs]/.test(y2)
        ? Math.max(1, Math.min(21, v2))
        : Math.max(0, Math.min(20, v2))
    function C2(t5) {
      var e3 = _2,
        i3 = w2,
        o3,
      ...
      if ('c' === y2) {
        ...
        if (m2) t5 = Wr(t5)
        if (M2 && 0 === +t5 && '+' !== c2) M2 = false
        e3 =
          (M2 ? ('(' === c2 ? c2 : s2) : '-' === c2 || '(' === c2 ? '' : c2) +
          e3
        i3 =
          ('s' === y2 ? Zr[8 + Yr / 3] : '') +
          i3 +
      ...
      if (g2 && !d2) t5 = n2(t5, 1 / 0)
      var N2 = e3.length + t5.length + i3.length,
        A2 = N2 < p2 ? new Array(p2 - N2 + 1).join(l3) : ''
      if (g2 && d2)
  ...
  function h2(t4, n3) {
    var e3 = l2(((t4 = Br(t4)), (t4.type = 'f'), t4)),
      i3 = 3 * Math.max(-8, Math.min(8, Math.floor(Rr(n3) / 3))),
      r3 = Math.pow(10, -i3),
      a3 = Zr[8 + i3 / 3]
    return function (t5) {
      return e3(r3 * t5) + a3
...
function aa(t3, n2) {
  return Math.max(
    0,
    3 * Math.max(-8, Math.min(8, Math.floor(Rr(n2) / 3))) - Rr(Math.abs(t3))
  )
}
function oa(t3, n2) {
...
function sa(t3, n2, e2, i2) {
  ...
  switch (i2.type) {
    case 's':
      ...
      if (null == i2.precision && !isNaN((a2 = aa(r2, o2)))) i2.precision = a2
      return ea(i2, o2)
    case '':
    case 'e':
    case 'g':
    ...
    case 'r':
      if (
        null == i2.precision &&
        !isNaN((a2 = oa(r2, Math.max(Math.abs(t3), Math.abs(n2)))))
      )
...
class ha {
  constructor(t3) {
    ...
    if (t3.nodeName) this.dContainer = t3
    else throw new Error('The tooltip has no valid container element.')
  }
  create() {
  ...
  ping(t3) {
    const n2 =
      t3.constructor === Array
        ? `<strong>${t3[0]}</strong><br>${t3[1]}: <em>${t3[2]}</em>`
        : t3
    const e2 =
...
function ca(t3) {
  if (!t3.ok) throw new Error(t3.status + ' ' + t3.statusText)
  if (204 === t3.status || 205 === t3.status) return
  return t3.json()
}
function fa(t3, n2) {
...
class pa {
  static getRandomColor(t3 = 'light', n2 = 170) {
    ...
    let i2 = []
    while (!i2.length || !this.colorFilter(t3, n2, i2)) i2 = [e2(), e2(), e2()]
    return ae(i2[0], i2[1], i2[2])
  }
  static colorFilter(t3, n2, e2) {
    let i2 = false
    if (!e2.length) i2 = false
    else if (!t3) i2 = true
    else {
      const r2 = (299 * e2[0] + 587 * e2[1] + 114 * e2[2]) / 1e3
      if ('light' === t3) i2 = r2 < n2
      else if ('dark' === t3) i2 = r2 > n2
    }
    return i2
  }
  ...
  static getRandomPalette(t3 = 10) {
    let n2 = t3
    const e2 = []
    while (n2--) e2.push(this.getRandomColor())
    return e2
  }
...
class ga {
  ...
  static getRandomData(t3, n2) {
    ...
    o2.jConfig = {
      ...
      aValues: (() => {
        const t4 = []
        let n3 = i2
        while (n3--) t4.push({ sName: `Type ${i2 - n3}` })
        return t4
      })(),
      bTrim: true,
    }
    ...
    while (s2--)
      o2.aData.push({
        ...
        aValues: (() => {
          const t4 = []
          let n3 = i2
          while (n3--) t4.push(da.getRandomInteger(r2, a2))
          return t4
        })(),
      })
    return o2
  ...
  static transformDataKeys(t3, n2) {
    return n2.map((n3) => {
      ...
      if (t3.aAxisKeys && !n3.sLabel) n3.sLabel = n3[t3.aAxisKeys[0]]
      return n3
    })
  }
  static addColoursToConfig(t3, n2 = true) {
    return t3.map((t4) => {
      if (!t4.sColor) t4.sColor = pa.getRandomColor().hex()
      if (n2) t4.oColor = pa.convertHexToRgb(t4.sColor)
      return t4
    })
  }
}
class va {
  constructor(t3 = {}) {
    ...
    if (!r2 && i2) r2 = document.getElementById(i2)
    if (r2) this.setContainer(r2)
    if (n2) this.setConfig(n2)
    if (e2) this.setData(e2)
  }
  setContainer(t3) {
    if (t3.nodeName) {
      t3.appendChild(this.dLoader)
      this.dContainer = t3
    } else throw new Error('No valid DOM element or ID provided for chart.')
  }
  setConfig(t3) {
    if (t3 && '[object Object]' === t3.toString()) {
      if (t3.aValues) t3.aValues = ga.addColoursToConfig(t3.aValues)
      this.jConfig = t3
    } else throw new Error('No valid configuration provided for chart.')
  }
  setData(t3, n2 = true) {
    if (t3 && true === Array.isArray(t3)) {
      if (this.jConfig && n2) t3 = ga.transformDataKeys(this.jConfig, t3)
      this.aData = t3
    } else throw new Error('No valid data provided for chart.')
  }
  updateData(t3, n2 = true, e2 = true) {
    this.setData(t3, n2)
    this.setDimensions()
    if (this.oAxis) this.oAxis.render()
    if (this.renderChart && e2) this.renderChart()
  }
  updateConfig(t3, n2 = false, e2 = false) {
    this.setConfig(t3)
    if (n2) this.setDimensions()
    if (this.renderChart) this.renderChart(true, e2)
  }
  setDimensions() {
  ...
  renderChart(t3, n2) {
    if (this.d3Title) this.d3Title.text(this.jConfig.sTitle)
  }
  init() {
    this.setDimensions()
    if (
...
class ma {
  constructor({
    ...
    if (t3 && n2) {
      ...
      this.iOffsetX = e2
      this.iOffsetY = i2
    } else throw new Error('Incorrect parameters provided to Key constructor.')
  }
  render() {
    ...
    const i2 = (t4, n3) => {
      let e3 = 0
      if (n3) for (let i3 = 0; i3 < n3; i3++) e3 += t4[i3].iLabelWidth
      return e3
    }
    e2.enter()
      .append('text')
      ...
      .attr('class', 'label')
      .attr('x', (t4, n3) => !!t4 && i2(this.aValues, n3))
      .attr('y', 8)
      .attr('width', 10)
      .attr('height', 10)
    ...
    r2.enter()
      .append('rect')
      .attr('class', 'key')
      .attr('fill', (t4) => t4.sColor)
      .attr('x', (t4, n3) => !!t4 && i2(this.aValues, n3) - 12)
      .attr('y', 0)
      .attr('width', 10)
      .attr('height', 10)
...
function Ea(t3, n2) {
  var e2 = [],
    ...
    u2 = t3 === wa || t3 === Ca ? -1 : 1,
    l2 = t3 === Ca || t3 === xa ? 'x' : 'y',
    h2 = t3 === wa || t3 === ba ? Na : Aa
  function c2(c3) {
    var f2 =
        null == i2 ? (n2.ticks ? n2.ticks.apply(n2, e2) : n2.domain()) : i2,
      d2 = null == r2 ? (n2.tickFormat ? n2.tickFormat.apply(n2, e2) : _a) : r2,
      p2 = Math.max(a2, 0) + s2,
      g2 = n2.range(),
      v2 = +g2[0] + 0.5,
      m2 = +g2[g2.length - 1] + 0.5,
      y2 = (n2.bandwidth ? Ta : ka)(n2.copy()),
      _2 = c3.selection ? c3.selection() : c3,
      w2 = _2.selectAll('.domain').data([null]),
      x2 = _2.selectAll('.tick').data(f2, n2).order(),
      b2 = x2.exit(),
      C2 = x2.enter().append('g').attr('class', 'tick'),
      M2 = x2.select('line'),
      N2 = x2.select('text')
    w2 = w2.merge(
      w2
    ...
    N2 = N2.merge(
      C2.append('text')
        ...
        .attr(l2, u2 * p2)
        .attr('dy', t3 === wa ? '0em' : t3 === ba ? '0.71em' : '0.32em')
    )
    if (c3 !== _2) {
      w2 = w2.transition(c3)
      x2 = x2.transition(c3)
      ...
      b2 = b2
        .transition(c3)
        .attr('opacity', Ma)
        .attr('transform', function (t4) {
          return isFinite((t4 = y2(t4)))
            ? h2(t4)
    ...
    w2.attr(
      ...
      t3 === Ca || t3 == xa
        ? o2
          ? 'M' + u2 * o2 + ',' + v2 + 'H0.5V' + m2 + 'H' + u2 * o2
          : 'M0.5,' + v2 + 'V' + m2
        : o2
        ? 'M' + v2 + ',' + u2 * o2 + 'V0.5H' + m2 + 'V' + u2 * o2
        : 'M' + v2 + ',0.5H' + m2
    )
    ...
    _2.filter(Sa)
      ...
      .attr('font-size', 10)
      .attr('font-family', 'sans-serif')
      .attr('text-anchor', t3 === xa ? 'start' : t3 === Ca ? 'end' : 'middle')
    _2.each(function () {
      this.__axis = y2
    })
  }
  ...
  c2.tickArguments = function (t4) {
    return arguments.length
      ? ((e2 = null == t4 ? [] : ya.call(t4)), c2)
      : e2.slice()
  }
  c2.tickValues = function (t4) {
    return arguments.length
      ? ((i2 = null == t4 ? null : ya.call(t4)), c2)
      : i2 && i2.slice()
  }
...
class Va {
  constructor(t3) {
    ...
    __publicField(this, 'iHeight')
    __publicField(this, 'jPadding')
    if (t3.d3Container) Object.assign(this, t3)
    else throw new Error('Incorrect parameters provided to Axis constructor.')
  }
  render() {
    this.renderAxisX()
    this.renderAxisY()
  ...
  renderAxisX() {
    ...
    this.d3Container
      ...
      .attr('class', 'x-labels')
      .text((t3) => da.truncateString(t3, this.iTruncate))
  ...
  renderLabels() {
    ...
    this.d3Container
      .append('text')
      .attr('class', 'labels')
      .attr('x', this.iHeight / -2 - this.jPadding.t / 2)
      .attr('y', 10)
    ...
    this.d3Container
      .append('text')
      .attr('class', 'labels')
      .attr('x', (this.iWidth + this.jPadding.l + this.jPadding.r) / 2)
...
class Da extends va {
  ...
  setDimensions() {
    ...
    this.oScaleX
      .domain(this.aData.map((t4) => t4.sLabel))
...
class Pa extends Da {
  ...
  renderChart(n2 = false, e2 = true) {
    ...
    i2.forEach((n3, i3) => {
      ...
      if (!this.aBars[i3]) {
        this.aBars[i3] = this.d3ChartGroup
          .selectAll(`rect.bars-${i3}`)
          .data(this.aData)
        this.aBars[i3]
          .enter()
          .append('rect')
...
Ha.prototype = Xa.prototype = {
  constructor: Ha,
  moveTo: function (t3, n2) {
    this._ +=
      'M' + (this._x0 = this._x1 = +t3) + ',' + (this._y0 = this._y1 = +n2)
  },
  closePath: function () {
    if (null !== this._x1) {
  ...
  quadraticCurveTo: function (t3, n2, e2, i2) {
    this._ +=
      'Q' + +t3 + ',' + +n2 + ',' + (this._x1 = +e2) + ',' + (this._y1 = +i2)
  },
  ...
  arcTo: function (t3, n2, e2, i2, r2) {
    ...
    if (null === this._x1)
      ...
      var f2 = e2 - a2,
        ...
        m2 = Math.sqrt(c2),
        y2 =
          r2 * Math.tan((Ia - Math.acos((p2 + c2 - g2) / (2 * v2 * m2))) / 2),
        _2 = y2 / m2,
        w2 = y2 / v2
      if (Math.abs(_2 - 1) > Oa)
  ...
  arc: function (t3, n2, e2, i2, r2, a2) {
    ...
    if (null === this._x1) this._ += 'M' + u2 + ',' + l2
    ...
    if (c2 > Ra)
      ...
      this._ +=
        ...
        h2 +
        ',' +
        (this._x1 = t3 + e2 * Math.cos(r2)) +
        ',' +
        (this._y1 = n2 + e2 * Math.sin(r2))
  },
  rect: function (t3, n2, e2, i2) {
    this._ +=
      'M' +
      (this._x0 = this._x1 = +t3) +
      ',' +
      (this._y0 = this._y1 = +n2) +
      'h' +
      +e2 +
      'v' +
      +i2 +
...
function Ga() {
  ...
  function o2(o3) {
    var s2,
      ...
      h2 = false,
      c2
    if (null == i2) a2 = r2((c2 = Xa()))
    for (s2 = 0; s2 <= u2; ++s2) {
      if (!(s2 < u2 && e2((l2 = o3[s2]), s2, o3)) === h2)
        if ((h2 = !h2)) a2.lineStart()
        else a2.lineEnd()
      if (h2) a2.point(+t3(l2, s2, o3), +n2(l2, s2, o3))
    }
    if (c2) return (a2 = null), c2 + '' || null
  }
  o2.x = function (n3) {
    return arguments.length
      ? ((t3 = 'function' === typeof n3 ? n3 : za(+n3)), o2)
      : t3
  }
  o2.y = function (t4) {
    return arguments.length
      ? ((n2 = 'function' === typeof t4 ? t4 : za(+t4)), o2)
      : n2
  }
  o2.defined = function (t4) {
    return arguments.length
      ? ((e2 = 'function' === typeof t4 ? t4 : za(!!t4)), o2)
      : e2
  }
  ...
  o2.context = function (t4) {
    return arguments.length
      ? (null == t4 ? (i2 = a2 = null) : (a2 = r2((i2 = t4))), o2)
      : i2
  }
  return o2
}
  ...
  renderChart(t3 = false) {
    ...
    if (t3) {
      this.aLines.forEach((t4, n3) => {
        this.aLines[n3] = this.d3ChartGroup
          .selectAll(`path.lines-${n3}`)
          .data([])
    ...
    if (t3) {
      this.aCircles.forEach((t4, n3) => {
        this.aCircles[n3] = this.d3ChartGroup
          .selectAll(`circle.circles-${n3}`)
          .data([])
    ...
    n2.forEach((t4, n3) => {
      ...
      if (!this.aLines[n3]) {
        ...
        this.d3ChartGroup
          .append('path')
          .data([this.aData])
          .attr('class', `line lines-${n3}`)
          .attr('stroke', r2)
      }
      this.aLines[n3]
        .x((t5) => e2(t5.sLabel) + e2.bandwidth() / 2)
        .y((t5) => i2(t5.aValues[n3]))
      this.d3ChartGroup
        .selectAll(`path.lines-${n3}`)
        .data([this.aData])
        .attr('d', this.aLines[n3])
      if (!this.aCircles[n3]) {
        this.aCircles[n3] = this.d3ChartGroup
          .selectAll(`circle.circles-${n3}`)
          .data(this.aData)
      ...
      this.d3ChartGroup
        .selectAll(`circle.circles-${n3}`)
        .data(this.aData)
        .attr('cy', (t5) => i2(t5.aValues[n3]))
        .attr('cx', (t5) => e2(t5.sLabel) + e2.bandwidth() / 2)
    })
  }
}
function Ka(t3, n2) {
  ...
  function i2() {
    var i3,
      ...
      o2 = 0,
      s2 = 0
    for (i3 = 0; i3 < r2; ++i3) (a2 = e2[i3]), (o2 += a2.x), (s2 += a2.y)
...
function Za(t3) {
  var n2 = +this._x.call(null, t3),
    e2 = +this._y.call(null, t3)
  return Qa(this.cover(n2, e2), n2, e2, t3)
}
function Qa(t3, n2, e2, i2) {
  if (isNaN(n2) || isNaN(e2)) return t3
  var r2,
    a2 = t3._root,
    o2 = { data: i2 },
    s2 = t3._x0,
    ...
    m2,
    y2
  if (!a2) return (t3._root = o2), t3
  while (a2.length) {
    if ((g2 = n2 >= (c2 = (s2 + l2) / 2))) s2 = c2
    else l2 = c2
    if ((v2 = e2 >= (f2 = (u2 + h2) / 2))) u2 = f2
    else h2 = f2
    if (((r2 = a2), !(a2 = a2[(m2 = (v2 << 1) | g2)]))) return (r2[m2] = o2), t3
  }
...
function to(t3) {
  ...
  for (e2 = 0; e2 < i2; ++e2) {
    if (
      isNaN((r2 = +this._x.call(null, (n2 = t3[e2])))) ||
      isNaN((a2 = +this._y.call(null, n2)))
    )
      continue
    o2[e2] = r2
    s2[e2] = a2
  ...
  if (u2 > h2 || l2 > c2) return this
  this.cover(u2, l2).cover(h2, c2)
  for (e2 = 0; e2 < i2; ++e2) Qa(this, o2[e2], s2[e2], t3[e2])
  return this
}
function no(t3, n2) {
  if (isNaN((t3 = +t3)) || isNaN((n2 = +n2))) return this
  var e2 = this._x0,
    i2 = this._y0,
    r2 = this._x1,
    a2 = this._y1
  if (isNaN(e2)) {
    ...
    if (this._root && this._root.length) this._root = s2
  }
  this._x0 = e2
  this._y0 = i2
  this._x1 = r2
...
function io(t3) {
  return arguments.length
    ? this.cover(+t3[0][0], +t3[0][1]).cover(+t3[1][0], +t3[1][1])
    : isNaN(this._x0)
    ? void 0
    : [
        [this._x0, this._y0],
...
function ao(t3, n2, e2) {
  var i2,
    ...
    p2,
    g2
  if (d2) f2.push(new ro(d2, r2, a2, h2, c2))
  if (null == e2) e2 = 1 / 0
  else {
    ;(r2 = t3 - e2), (a2 = n2 - e2)
    ;(h2 = t3 + e2), (c2 = n2 + e2)
  ...
  while ((p2 = f2.pop())) {
    ...
    if (d2.length) {
      var v2 = (o2 + u2) / 2,
        m2 = (s2 + l2) / 2
      f2.push(
        new ro(d2[3], v2, m2, u2, l2),
        new ro(d2[2], o2, m2, v2, l2),
        new ro(d2[1], v2, s2, u2, m2),
        new ro(d2[0], o2, s2, v2, m2)
      )
      if ((g2 = ((n2 >= m2) << 1) | (t3 >= v2))) {
        p2 = f2[f2.length - 1]
      ...
      var y2 = t3 - +this._x.call(null, d2.data),
        _2 = n2 - +this._y.call(null, d2.data),
        w2 = y2 * y2 + _2 * _2
      if (w2 < e2) {
...
function oo(t3) {
  if (
    isNaN((h2 = +this._x.call(null, t3))) ||
    isNaN((c2 = +this._y.call(null, t3)))
  )
    return this
  var n2,
    e2 = this._root,
  ...
  if (e2.length)
    while (true) {
      if ((p2 = h2 >= (f2 = (o2 + u2) / 2))) o2 = f2
      else u2 = f2
      if ((g2 = c2 >= (d2 = (s2 + l2) / 2))) s2 = d2
      else l2 = d2
      if (!((n2 = e2), (e2 = e2[(v2 = (g2 << 1) | p2)]))) return this
      if (!e2.length) break
      if (n2[(v2 + 1) & 3] || n2[(v2 + 2) & 3] || n2[(v2 + 3) & 3])
        (i2 = n2), (m2 = v2)
    }
  while (e2.data !== t3) if (!((r2 = e2), (e2 = e2.next))) return this
  if ((a2 = e2.next)) delete e2.next
  if (r2) return a2 ? (r2.next = a2) : delete r2.next, this
  if (!n2) return (this._root = a2), this
  a2 ? (n2[v2] = a2) : delete n2[v2]
  if (
    (e2 = n2[0] || n2[1] || n2[2] || n2[3]) &&
    e2 === (n2[3] || n2[2] || n2[1] || n2[0]) &&
    !e2.length
  )
    if (i2) i2[m2] = e2
    else this._root = e2
...
function so(t3) {
  for (var n2 = 0, e2 = t3.length; n2 < e2; ++n2) this.remove(t3[n2])
  return this
}
function uo() {
  return this._root
...
function ho(t3) {
  var n2 = [],
    ...
    s2,
    u2
  if (i2) n2.push(new ro(i2, this._x0, this._y0, this._x1, this._y1))
  while ((e2 = n2.pop()))
    if (
      !t3(
        (i2 = e2.node),
      ...
      var l2 = (a2 + s2) / 2,
        h2 = (o2 + u2) / 2
      if ((r2 = i2[3])) n2.push(new ro(r2, l2, h2, s2, u2))
      if ((r2 = i2[2])) n2.push(new ro(r2, a2, h2, l2, u2))
      if ((r2 = i2[1])) n2.push(new ro(r2, l2, o2, s2, h2))
      if ((r2 = i2[0])) n2.push(new ro(r2, a2, o2, l2, h2))
    }
  return this
}
function co(t3) {
  ...
  while ((i2 = n2.pop())) {
    ...
    if (r2.length) {
      var a2,
        ...
        h2 = (o2 + u2) / 2,
        c2 = (s2 + l2) / 2
      if ((a2 = r2[0])) n2.push(new ro(a2, o2, s2, h2, c2))
      if ((a2 = r2[1])) n2.push(new ro(a2, h2, s2, u2, c2))
      if ((a2 = r2[2])) n2.push(new ro(a2, o2, c2, h2, l2))
      if ((a2 = r2[3])) n2.push(new ro(a2, h2, c2, u2, l2))
    }
    e2.push(i2)
  }
  while ((i2 = e2.pop())) t3(i2.node, i2.x0, i2.y0, i2.x1, i2.y1)
  return this
}
function fo(t3) {
  return t3[0]
...
function _o(t3) {
  var n2 = { data: t3.data },
    e2 = n2
  while ((t3 = t3.next)) e2 = e2.next = { data: t3.data }
  return n2
}
var wo = (mo.prototype = yo.prototype)
wo.copy = function () {
  var t3 = new yo(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
    n2 = this._root,
    e2,
    i2
  if (!n2) return t3
  if (!n2.length) return (t3._root = _o(n2)), t3
...
function No(t3) {
  ...
  function c2(i3) {
    ...
    for (var c3 = 0; c3 < i3; ++c3) {
      ...
      for (u3 = 0; u3 < l3; ++u3) {
        h3 = t3[u3]
        if (null == h3.fx) h3.x += h3.vx *= o2
        else (h3.x = h3.fx), (h3.vx = 0)
        if (null == h3.fy) h3.y += h3.vy *= o2
        else (h3.y = h3.fy), (h3.vy = 0)
      }
    }
    return n2
  }
  function f2() {
    for (var n3 = 0, e3 = t3.length, i3; n3 < e3; ++n3) {
      ...
      if (null != i3.fx) i3.x = i3.fx
      if (null != i3.fy) i3.y = i3.fy
      if (isNaN(i3.x) || isNaN(i3.y)) {
        var r3 = Co * Math.sqrt(n3),
          a3 = n3 * Mo
        i3.x = r3 * Math.cos(a3)
        i3.y = r3 * Math.sin(a3)
      }
      if (isNaN(i3.vx) || isNaN(i3.vy)) i3.vx = i3.vy = 0
    }
  }
  function d2(n3) {
    if (n3.initialize) n3.initialize(t3)
    return n3
  }
  f2()
  return (n2 = {
    ...
    force: function (t4, e3) {
      return arguments.length > 1
        ? (null == e3 ? s2.remove(t4) : s2.set(t4, d2(e3)), n2)
        : s2.get(t4)
    },
...
function Ao() {
  ...
  function u2(i3) {
    var r3,
      a3 = t3.length,
      o3 = mo(t3, xo, bo).visitAfter(h2)
    for (e2 = i3, r3 = 0; r3 < a3; ++r3) (n2 = t3[r3]), o3.visit(c2)
  }
  function l2() {
    if (!t3) return
    var n3,
      ...
      a3
    r2 = new Array(e3)
    for (n3 = 0; n3 < e3; ++n3) (a3 = t3[n3]), (r2[a3.index] = +i2(a3, n3, t3))
  }
  function h2(t4) {
    var n3 = 0,
      e3,
  ...
  function c2(t4, i3, u3, l3) {
    ...
    if ((f2 * f2) / s2 < d2) {
      if (d2 < o2) {
        if (0 === h3) (h3 = Ja()), (d2 += h3 * h3)
        if (0 === c3) (c3 = Ja()), (d2 += c3 * c3)
        if (d2 < a2) d2 = Math.sqrt(a2 * d2)
        n2.vx += (h3 * t4.value * e2) / d2
        n2.vy += (c3 * t4.value * e2) / d2
      }
      return true
    } else if (t4.length || d2 >= o2) return
  ...
  u2.strength = function (t4) {
    return arguments.length
      ? ((i2 = 'function' === typeof t4 ? t4 : Ua(+t4)), l2(), u2)
      : i2
  }
...
class ko extends va {
  ...
  setDimensions() {
    super.setDimensions()
    this.oScaleColor
      .domain([0, hr(this.aData, (t3) => t3[this.jConfig.aValues[1].sKey])])
  ...
  renderChart() {
    ...
    this.oForce = No()
      ...
      .force(
        'charge',
        Ao().strength((t3) => (t3[o2] * (t3[o2] / 2)) / -150)
      )
      .force('center', Ka(this.iWidth / 2, this.iHeight / 2))
      .on('tick', () => {
        c2()
      })
    if (!this.d3Circles) {
      ...
      this.d3Circles
        ...
        .on('mousemove', (t3) => {
          this.oTooltip.ping(
            `<strong>${t3.sLabel}</strong><br>${s2}: <em>${t3[o2]}</em><br>${l2}: <em>${t3[u2]}</em>`
          )
        })
        .on('mouseout', () => this.oTooltip.hide())
        .attr('class', 'circles')
        .attr('fill', (t3) => this.oScaleColor(t3[u2]))
        .attr('r', 0)
        .transition()
        .ease(t)
    ...
    this.oKey = new ma({
      ...
      aValues: [
        { sName: 0, sColor: h2[0] },
        { sName: this.oScaleColor.domain()[1], sColor: h2[1] },
      ],
